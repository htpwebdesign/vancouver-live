...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$vancouver_live_description = get_bloginfo( 'description', 'display' );
			if ( $vancouver_live_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $vancouver_live_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
